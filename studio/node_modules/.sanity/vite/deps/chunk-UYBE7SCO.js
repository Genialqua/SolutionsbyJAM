...
function tt(e, s, i) {
  var a2 = Z(e), c4 = e, u2 = !k(e), d2 = s.attrs, p2 = void 0 === d2 ? S : d2, f2 = s.componentId, m3 = void 0 === f2 ? (function(e2, t) {
  ...
  })(e) : y2, N2 = s.displayName && s.componentId ? "".concat(A(s.displayName), "-").concat(s.componentId) : s.componentId || m3, C2 = a2 && c4.attrs ? c4.attrs.concat(p2).filter(Boolean) : p2, P2 = s.shouldForwardProp;
  ...
  function D2(e2, s2) {
    return (function(e3, s3, i2) {
      var a3 = e3.attrs, c5 = e3.componentStyle, u3 = e3.defaultProps, l2 = e3.foldedComponentIds, d3 = e3.styledComponentId, p3 = e3.target, f3 = h ? void 0 : import_react.default.useContext(Je), m4 = Ve(), y3 = e3.shouldForwardProp || m4.shouldForwardProp;
...
function useFloating(options) {
  ...
  const [latestMiddleware, setLatestMiddleware] = React5.useState(middleware2);
  ...
  const setFloating = React5.useCallback((node2) => {
...
var context = import_react53.default.createContext(true);
function forbiddenInRender() {
  throw new Error("A function wrapped in useEffectEvent can't be called during rendering.");
}
var isInvalidExecutionContextForEventFunction = "use" in import_react53.default ? () => {
  try {
    return import_react53.default.use(context);
  } catch {
    return false;
  }
} : () => false;
function useEffectEvent(fn) {
  const ref = import_react53.default.useRef(forbiddenInRender);
  return import_react53.default.useInsertionEffect(() => {
    ref.current = fn;
  }, [fn]), (...args) => {
...
function ThemeProvider(props) {
  ...
  let t2;
  $2[9] !== children || $2[10] !== theme ? (t2 = (0, import_jsx_runtime12.jsx)(Ke, { theme, children }), $2[9] = children, $2[10] = theme, $2[11] = t2) : t2 = $2[11];
  let t3;
...
var LazyRefractor = (0, import_react54.lazy)(() => import("./refractor-XWZOILIV.js"));
...
//# sourceMappingURL=chunk-UYBE7SCO.js.map
